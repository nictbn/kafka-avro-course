...
public class SchemaEvolutionExamples {
    public static void main(String[] args) throws IOException {
        ...
        DataFileWriter<CustomerV1> dataFileWriter = new DataFileWriter<>(datumWriter);
        ...
        DatumReader<CustomerV2> datumReaderV2 = new SpecificDatumReader<>(CustomerV2.class);
        DataFileReader<CustomerV2> dataFileReaderV2 = new DataFileReader<>(file, datumReaderV2);
        ...
        DatumWriter<CustomerV2> datumWriterV2 = new SpecificDatumWriter<>(CustomerV2.class);
        DataFileWriter<CustomerV2> dataFileWriterV2 = new DataFileWriter<>(datumWriterV2);
        ...
        DataFileReader<CustomerV1> dataFileReader = new DataFileReader<>(file2, datumReader);
